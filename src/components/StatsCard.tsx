...
export function StatsCard() {
    return (
        <div className="bg-[#1e3a8a] text-white rounded-3xl p-8 flex flex-col items-center justify-center text-center shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <h2 className="text-5xl font-bold mb-1">15,400</h2>
